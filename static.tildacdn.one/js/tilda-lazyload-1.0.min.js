...
function t_lazyLoad__appendImgStatToArr(e, t) {
  if (void 0 !== navigator.sendBeacon) {
    ...
    if (n) {
      var a = { time: i - t };
      0 === n.indexOf("/" + t_lazyload__getThumbDomainName()) && (a.th = "y"),
        0 === n.indexOf("/static.tildacdn") && (a.st = "y"),
        (a.th || a.st) && window.t_loadImgStats.push(a);
    }
  }
}
function t_lazyload__ping(e) {
  var t = "/" + e + ".tildacdn.com";
  if ("static" == e) {
...
function t_lazyload__applyZeroHeightFix(e) {
  e.getAttribute("data-lazy-zero-height-fix") ||
    (e.setAttribute("data-lazy-previous-height", e.style.height),
    (e.style.height = "1px"),
    e.setAttribute("data-lazy-zero-height-fix", "y"));
}
function t_lazyload__revertZeroHeightFix(e) {
  var t = e.getAttribute("data-lazy-previous-height");
  e.getAttribute("data-lazy-zero-height-fix") &&
    ((e.style.height = t || ""),
    e.removeAttribute("data-lazy-zero-height-fix"),
    e.removeAttribute("data-lazy-previous-height"));
}
(window.lazy = "y"),
  ...
  (function (e, t) {
    ...
    function w(e, t, i, o) {
      ...
      if (l) {
          ...
          if (M)
            "50%" == (p = (x = M.split(" "))[0])
              ...
              "50%" == (h = x[1])
                ...
                ? (h = "top")
                : "100%" == h && (h = "bottom");
          (k = "contain" == (w = N.backgroundSize) ? "contain" : "cover"),
        ...
        if ("cover" == k && d > 0 && s > 0 && d <= 1e3)
          ...
          else if (f(t, "tn-atom") || f(t, "tn-atom__img"));
          else {
            var x;
            f(t, "t-cover__carrier") || (k = "resize"),
              (d = (x = v(k, d, s, 100))[0]),
              (s = x[1]);
          }
        if (
    ...
    function z(e, t, i, n, a, o, r) {
      ...
      var c = document.getElementById("allrecords"),
        ...
        x = ".webp",
        _ = -1 !== d.indexOf(x, d.length - 5);
      return "y" == window.lazy_webp && u && !_ && (d += ".webp"), d;
    }
    function A(e) {
      ...
      var i = h(t.join("/")),
        ...
        a = n && "y" === n.getAttribute("data-tilda-ts"),
        o = ".webp",
        r = -1 !== i.indexOf(o, i.length - 5);
      return a && !r && (i += ".webp"), i;
    }
    function O(e, t, i) {
          ...
          if (a.length > 3)
            for (var d = 0; d < a.length; d++)
              "" !== a[d] &&
                ...
                d == a.length - 1 && (l = a[d]));
          if ("" !== o && "" !== l)
            k(e, (n = "/static3.tildacdn.com/" + o + "/" + l));
    ...
    return (
      (I.prototype._showOnLoad = function (e) {
        ...
        function a() {
          null !== i &&
            ...
            w(e, e, i.data_srcset, i.data_src),
            i.callback_set && i.callback_set(e),
            _(e, i.class_loading),
            x(e, i.class_loaded),
            t_lazyload__revertZeroHeightFix(e),
        ...
        !e.getAttribute("src") &&
          ...
          x(e, i.class_loading),
          (n = s()),
          w(t, e, i.data_srcset, i.data_src);
      }),
      (I.prototype._showOnAppear = function (e) {
        ...
        ("IMG" !== e.tagName && "IFRAME" !== e.tagName) ||
          ...
          x(e, t.class_loading)),
          (i = s()),
          w(e, e, t.data_srcset, t.data_src),
              ...
              if (
                ...
                if (
                  (0 === t.boundingClientRect.height &&
                    o &&
                    t_lazyload__applyZeroHeightFix(n),
                  n.wasProcessed)
                )
                  return (
      ...
      (I.prototype.loadAnimatedImages = function () {
        ...
        for (e = 0; e < a; e++)
          if (f((t = n[e]), "tn-atom__img") || f(t, "tn-atom")) {
            var l = g(t, "tn-elem"),
